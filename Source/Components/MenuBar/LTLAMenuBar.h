...
#include "../Source/Components/CommandManager/CommandManager.h"

/** This class represents the menubar located at the top for the applciation,
The menu bar uses a command manager to respond to the various options. */
