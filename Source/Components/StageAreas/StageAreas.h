...
#include "../AudioEngine/AudioPanelObject.h"

/** This class is responsible for the UI side of a single stage
	area. This uses a JUCE Path to set the coordinates and draw the
	stage along with various handy JUCE Path functions which can
	determine whether a performers ellipse is inside the path. */
