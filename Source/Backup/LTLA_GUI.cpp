...
void LTLA_GUI::paint(Graphics& g) 
{
	...
	PaintTrackedEllipse(g, EllipseCoordinates[0].x, EllipseCoordinates[0].y, Colours::blue); // Draw Circle to represent tracked position.
	PaintTrackedEllipse(g, EllipseCoordinates[1].x, EllipseCoordinates[1].y, Colours::red); // Draw Circle to represent tracked position.
	PaintTrackedEllipse(g, EllipseCoordinates[2].x, EllipseCoordinates[2].y, Colours::green); // Draw Circle to represent tracked position.
	PaintTrackedEllipse(g, EllipseCoordinates[3].x, EllipseCoordinates[3].y, Colours::grey); // Draw Circle to represent tracked position.
	PaintTrackedEllipse(g, EllipseCoordinates[4].x, EllipseCoordinates[4].y, Colours::black); // Draw Circle to represent tracked position.
	PaintTrackedEllipse(g, EllipseCoordinates[5].x, EllipseCoordinates[5].y, Colours::purple); // Draw Circle to represent tracked position.
